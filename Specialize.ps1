...
try
{
    ...
    $baseUrl = "https://raw.github.com/CliMz/windows-openstack-imaging-tools/master"

    # Put the wallpaper in place
    $wallpaper_dir = "$ENV:SystemRoot\web\Wallpaper\Flexinfra"
    ...
    $wallpaper = "Wallpaper-Flexinfra-2013.jpg"
